  ...
  const sampleListResponse = [
      ...
      assets: [
        {
          ...
          browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/app-v0.2.3-win/P3.Platform_0.2.3_x64_en-US.msi",
    ...
    },
    {
      ...
      assets: [
        {
          name: "latest.json",
          browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/win-stable/latest.json",
          size: 256,
        },
      ],
    },
...
describe("selectLatestArchive", () => {
  ...
  const winMsi = (v) => ({
    ...
    browser_download_url: `https://github.com/Pace-IAS/IAS/releases/download/app-v${v}-win/P3.Platform_${v}_x64_en-US.msi`,
  });
  const macDmg = (v) => ({
    name: `P3.Platform_${v}_aarch64.dmg`,
    browser_download_url: `https://github.com/Pace-IAS/IAS/releases/download/app-v${v}-mac/P3.Platform_${v}_aarch64.dmg`,
  });
...
describe("chooseAction", () => {
  ...
  it("strips app-v prefix from tag_name in the download view's version (e.g. app-v0.2.0 → 0.2.0)", () => {
    const trustedAsset = {
      name: "installer.msi",
      browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/app-v0.2.0/installer.msi",
    };
  ...
  it("leaves a bare version string unchanged in the download view (e.g. 0.2.0 → 0.2.0)", () => {
    const trustedAsset = {
      name: "installer.msi",
      browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/0.2.0/installer.msi",
    };
  ...
  const dmgAsset = {
    name: "PaceIAS_0.2.0_aarch64.dmg",
    browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/app-v0.2.0/PaceIAS_0.2.0_aarch64.dmg",
  };
  ...
  it("returns kind:download when the .msi URL starts with https://github.com/ (trusted origin)", () => {
    const trustedAsset = {
      name: "installer.msi",
      browser_download_url: "https://github.com/Pace-IAS/IAS/releases/download/v1.0.0/installer.msi",
    };
